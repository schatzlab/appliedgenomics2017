...
|3. | Tu 2/7  | Whole Genome Assembly and Alignment | * [Velvet: Algorithms for de novo short read assembly using de Bruijn graphs](http://genome.cshlp.org/content/18/5/821.full) <br> * FALCON-unzip: [Phased diploid genome assembly with single-molecule real-time sequencing](http://www.nature.com/nmeth/journal/v13/n12/full/nmeth.4035.html), <br> * MUMmer: [Alignment of Whole Genomes](http://mummer.sourceforge.net/MUMmer.pdf), * [Quake: quality-aware detection and correction of sequencing errors](http://genomebiology.biomedcentral.com/articles/10.1186/gb-2010-11-11-r116), Allpaths-LG: [High-quality draft assemblies of mammalian genomes from massively parallel sequence data](http://www.pnas.org/content/108/4/1513)] |
