...
|9. | Tu 2/28 | Third Generation Sequencing | * [Resolving the complexity of the human genome using single-molecule sequencing (Chaisson et al, 2015, Nature)](http://www.nature.com/nature/journal/v517/n7536/abs/nature13907.html) <br> * FALCON-unzip: [Phased diploid genome assembly with single-molecule real-time sequencing (Chin et al, 2016, Nature Methods)](http://www.nature.com/nmeth/journal/v13/n12/full/nmeth.4035.html) <br> * [Assemblytics: a web analytics tool for the detection of variants from an assembly](https://academic.oup.com/bioinformatics/article-abstract/32/19/3021/2196631/Assemblytics-a-web-analytics-tool-for-the)|
